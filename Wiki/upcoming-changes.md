...
This page contains a summary of features, improvements, balance changes, and quality-of-life updates discussed by the development team during Town Halls.
...
The exact implementation and progression system are still being developed.
...
- New Legendary armor
- Specialized equipment and gear pieces
- Potential Legendary attachments
- Potential Legendary ammunition
The development team has specifically discussed moving toward more specialized Legendary equipment rather than only creating increasingly powerful weapons.
...
The exact replacement mechanics have not yet been finalized.
...
Additional improvements to how certain Skill Tree abilities are accessed through commands are also being considered.
...
The achievement UI is expected to be improved to communicate progression and rewards more clearly.
...
Simply creating weaker copies of existing Legendaries as separate tiers is not the intended approach.
...
A different solution is being considered.
...
Additional XP-related systems may be introduced as the Skill Tree develops.
...
The exact bonuses and progression are still being evaluated.
...
- Better Air Drop management
- Improved UI controls for closing menus
- Additional community events
- Expanded specialized gear
...
The V2 Skill Tree is intentionally designed to give players more freedom in how they specialize rather than forcing them through a fixed path.

New systems are expected to be introduced and refined over time as the development team collects player feedback and gameplay data.