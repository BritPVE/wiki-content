...
1. Buy **Tactical Gloves** from Outpost.
   - The best purchase price is **20 Scrap**, while the worst is around **80 Scrap**.
   - Gloves can only be purchased **one at a time**, which is why this method doesn't scale well.

2. Recycle the Tactical Gloves.
   - Each glove yields approximately:
     - **288 Cloth**
     - **12 Leather**

3. Use **`/pricecheck cloth`** and sell the Cloth in the world offering the highest rate *(maximum: **2 RP** per Cloth).*

4. Sell the Leather as well. While it's only a by-product, it provides a small amount of extra RP.

> 💡 **Profit Example**
>
> Assuming:
>
> - Tactical Gloves cost **20 Scrap**
> - Cloth sells for **2 RP** each
> - One glove yields **288 Cloth** and **12 Leather**
>
> **Calculation**
>
> ```
> 288 × 2 = 576 RP
> 576 RP + Leather value ≈ 596 RP
>
> 596 ÷ 20 = 29.8 RP per Scrap
> ```
>
> This results in a theoretical return of **approximately 2980%**.
>
> Since Tactical Gloves are not always available at the minimum price, a more realistic average is **around 2400%**.
