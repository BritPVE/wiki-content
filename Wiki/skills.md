...
| **Wild Sense** | Snapshots nearby collectables within a 100m radius. 60s cooldown. | 1 | 5 SP |
...
| **Feeding Frenzy** | Reduces bite time by 30% per level. | 3 | 1 SP / level |
...
| **Skilled Chef** | Improves cooking craft speed and buff duration by 100%. | 1 | 5 SP |
| **Chemical Chef** | Improves mixing and cooking speed by 100%. | 1 | 5 SP |
...
| **Seasoned Sailor** | Increases boat speed while mounted. +100% mounted acceleration. | 1 | 1 SP |
| **Prodigious Pilot** | Increases helicopter speed while mounted. +150% mounted acceleration. | 1 | 1 SP |
